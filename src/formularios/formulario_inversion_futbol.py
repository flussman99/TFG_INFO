...
class FormularioInversionFutbol():
    ...
    def actualizar_lotajes(self, event):
        ...
        if self.label_lotaje is None:
            ...
            self.lotaje_usuario = tk.Label(self.frame_combo_boxs, text="Balance disponible: " + str(self.lotaje_actual), font=("Aptos", 10), bg=COLOR_CUERPO_PRINCIPAL, fg="black", wraplength=200)

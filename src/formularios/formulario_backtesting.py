...
from formularios.formulario_backtesting_creativas import FormularioBackTestingCreativas
...
class FormularioBackTesting():
    ...
    def superior(self):
        ...
        self.boton_operaciones_clasicas = tk.Button(self.frame_superior, image=self.icono_operaciones_clasicas, bg="lightblue", command=self.operaciones_clasicas, borderwidth=0, highlightthickness=0)        

...
class FormularioCreativas():
    ...
    def opciones(self):
        ...
        #Frame botones futbol
        self.frame_botones_futbol = tk.Frame(self.frame_opciones, bg=COLOR_CUERPO_PRINCIPAL)
        self.frame_botones_futbol.grid(row=2, column=2, columnspan=4, sticky="w")

        # Boton de "Empezar backtesting"
        self.boton_empezar_backtesting_futbol = tk.Button(self.frame_botones_futbol, text="Empezar Backtesting", font=("Aptos", 12), bg="green", fg="white", command=self.futbol) 
        self.boton_empezar_backtesting_futbol.pack(side="right", padx=5)

        #boton para "Empezar inversión"
        self.boton_empezar_inversion_futbol = tk.Button(self.frame_botones_futbol, text="Empezar Inversión", font=("Aptos", 12), bg="green", fg="white", command=self.invertirfutbol)
        self.boton_empezar_inversion_futbol.pack(side="right", padx=5)
        ...
        #frame botones formula 1
        self.frame_botones_formula1 = tk.Frame(self.frame_opciones, bg=COLOR_CUERPO_PRINCIPAL)
        self.frame_botones_formula1.grid(row=4, column=2, columnspan=4, sticky="w")

        # Boton de "Empezar backtesting"
        self.boton_empezar_backtesting_formula1 = tk.Button(self.frame_botones_formula1, text="Empezar Backtesting", font=("Aptos", 12), bg="green", fg="white", command=self.formula1)
        ...
        #frame botones cine
        self.frame_botones_cine = tk.Frame(self.frame_opciones, bg=COLOR_CUERPO_PRINCIPAL)
        self.frame_botones_cine.grid(row=6, column=2, columnspan=4, sticky="w")

        # Boton de "Empezar backtesting"
        self.boton_empezar_backtesting_cine = tk.Button(self.frame_botones_cine, text="Empezar Backtesting", font=("Aptos", 12), bg="green", fg="white", command=self.cine)
    ...
    def update(self):
        ...
        self.descripcion_futbol.configure(font=("Aptos",  int(int(min(self.frame_width, self.frame_height) * 0.2)*0.1)))
        ...
        self.descripcion_formula1.configure(font=("Aptos",  int(int(min(self.frame_width, self.frame_height) * 0.2)*0.1)))
        self.frame_descripcion_cine.config(width=self.frame_width-25)
        self.descripcion_cine.config(wraplength=self.frame_width-25)
        self.descripcion_cine.configure(font=("Aptos",  int(int(min(self.frame_width, self.frame_height) * 0.2)*0.1)))

        #Ajustar el tamaño de los botones y la fuente de los botones
        self.boton_empezar_backtesting_futbol.configure(width=int(self.frame_width * 0.025))
        self.boton_empezar_backtesting_futbol.configure(font=("Aptos",  int(int(min(self.frame_width, self.frame_height) * 0.2)*0.1), "bold"))
        self.boton_empezar_backtesting_formula1.configure(width=int(self.frame_width * 0.025))
        self.boton_empezar_backtesting_formula1.configure(font=("Aptos",  int(int(min(self.frame_width, self.frame_height) * 0.2)*0.1), "bold"))
        self.boton_empezar_backtesting_cine.configure(width=int(self.frame_width * 0.025))
        self.boton_empezar_backtesting_cine.configure(font=("Aptos",  int(int(min(self.frame_width, self.frame_height) * 0.2)*0.1), "bold"))
        self.boton_empezar_inversion_futbol.configure(width=int(self.frame_width * 0.025))
        self.boton_empezar_inversion_futbol.configure(font=("Aptos",  int(int(min(self.frame_width, self.frame_height) * 0.2)*0.1), "bold"))
        self.boton_empezar_inversion_formula1.configure(width=int(self.frame_width * 0.025))
        self.boton_empezar_inversion_formula1.configure(font=("Aptos",  int(int(min(self.frame_width, self.frame_height) * 0.2)*0.1), "bold"))
        self.boton_empezar_inversion_cine.configure(width=int(self.frame_width * 0.025))
        self.boton_empezar_inversion_cine.configure(font=("Aptos",  int(int(min(self.frame_width, self.frame_height) * 0.2)*0.1), "bold"))
